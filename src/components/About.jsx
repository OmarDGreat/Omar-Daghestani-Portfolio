...
import AboutMe from '../assets/icon.jpg'
      ...
      <div className='container mx-auto px-8 md:px-16 lg:px-24'>
        ...
        <div className='flex flex-col md:flex-row items-center md:space-x-12'>
          ...
          <div className="flex-1">
            <p className='text-lg mb-8'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Numquam cupiditate ipsa minima
              dicta tenetur similique, quibusdam reprehenderit possimus dolores at, provident molestiae
              neque aut pariatur laudantium odit fugiat? Quidem, dicta!
            </p>
            ...
            <div className='space-y-4'>
              <div className='flex items-center'>
                <label htmlFor="htmlandcss" className='w-2/12'>Node</label>
                <div className='grow bg-gray-800 rounded-full h-2.5'>
                  <div className='bg-gradient-to-r from-green-400 to-blue-500 h-2.5 
